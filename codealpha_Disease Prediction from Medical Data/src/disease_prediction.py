"""
Disease prediction pipeline for breast_cancer, diabetes, and heart datasets.
...
def load_dataset(name: str) -> pd.DataFrame:
    ...
    for url in urls:
        if try_download_file(url, local_path):
            ...
            return df
    raise FileNotFoundError(f"Dataset {name} not found at {local_path} and automatic download failed.")
